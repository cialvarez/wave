class CreateMemberHierarchies < ActiveRecord::Migration
  def change
    create_table :member_hierarchies, :id => false do |t|
     ...
     add_index :member_hierarchies, [:ancestor_id, :descendant_id, :generations],
               :unique => true, :name => "member_anc_desc_udx"

     # For "all ancestors of…" selects,
     add_index :member_hierarchies, [:descendant_id],
